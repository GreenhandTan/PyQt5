...
from util.common_util import msg_box, get_return_day, get_current_time, APP_ICON, SYS_STYLE, PATTERS, \
    set_le_reg
...
class BorrowBookWindow(Ui_Form, QWidget):
    ...
    def borrow_book(self):
        ...
        borrow_info = [self.book_id, self.book_name, self.current_user, 1, borrow_day, get_current_time(),
